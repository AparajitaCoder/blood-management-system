...
$sql="INSERT INTO   tblhospital(Name,MobileNumber,EmailId,Password,Address) VALUES(:fullname,:mobile,:email,:password,:address)";
...
<head>
    ...
    <title>BMS | Become A Hospital</title>
...
<?php include('includes/header.php');?>
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">Become a <small>Hospital</small></h1>

        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="index.php">Home</a>
            </li>
            <li class="breadcrumb-item active">Become a Hospital</li>
        </ol>
